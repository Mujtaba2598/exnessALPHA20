...
console.log('🕋 100% HALAL EXNESS TRADING BOT - FIXED BALANCE');
console.log('📦 Version: 18.1.0');
...
// ==================== BALANCE HELPER ====================
// Fetches the latest account info directly from Exness via TickerAll
async function fetchBalance(accountId) {
    try {
        ...
        console.log(`💰 Balance fetched: ${balance} ${currency} (raw: ${JSON.stringify(accountInfo)})`);
        ...
        console.warn(`⚠️ Using last known balance: ${lastBalance}`);
        return { balance: lastBalance, currency: 'USD', full: null };
    }
}
